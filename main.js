...
function main() {
  ...
  var sprites = gamejs.image.load('sprites1.png');
  var surfaceCache = [];
  var maskCache = [];
  ...
  function gameTick(msDuration) {
    if(activeGame){
      ...
      display.blit(defaultFont.render("Player 1: ", "#000000"), [0, 470]);
      display.blit(defaultFont.render(player1.health, "#000000"), [170, 470]);
      display.blit(defaultFont.render("Controls: W A S D SPACE", "#000000"), [0, 510]);
      display.blit(defaultFont.render("Player 2: ", "#000000"), [600, 470]);
      display.blit(defaultFont.render(player2.health, "#000000"), [770, 470]);
      display.blit(defaultFont.render("Controls: \u2191 \u2193 \u2190 \u2192 ENTER", "#000000"), [600, 510]);
